...
function eliminarPropiedad(objeto, unaPropiedad) {
  // Elimina la propiedad de objeto cuyo nombre está 
  //pasado por el parametro unaPropiedad 
...
function tieneEmail(usuario) {
  ...
  // definido para la propiedad "email" (debe ser string)
...
function tienePropiedad(objeto, propiedad) {
  ...
  // una propiedad (key) cuyo nombre es igual al valor 
...
function actualizarPassword(usuario, nuevaPassword) {
  // Reemplaza la contraseña (password) existente en el objeto "usuario" 
...
function sumarLikesDeUsuario(usuario) {
  ...
  for (var i = 0; i < usuario.posts.length; i++){
    plus = usuario.posts[i].likes + plus;
  }
  return plus;
}
